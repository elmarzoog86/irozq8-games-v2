      ...
      <div className="flex-1 p-6 flex flex-col items-center justify-center">
        <AnimatePresence mode="wait">
          ...
          {state.status === 'judging' && (
            <motion.div key="judging" className="text-center space-y-6">
              <Timer className="w-20 h-20 text-brand-gold mx-auto animate-pulse" />
              <h2 className="text-4xl font-black italic text-white">
                جاري التقييم...
              </h2>
              <p className="text-brand-gold/50">الستريمر يقرر النتيجة</p>
            </motion.div>
          )}
