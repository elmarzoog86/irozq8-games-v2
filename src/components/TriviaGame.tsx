      ...
      return (
        <div className="flex flex-col items-center justify-center h-full w-full font-arabic" dir="rtl">
          ...
          <p className="text-xl text-zinc-400 mb-8">
            اكتب <span className="text-yellow-500 font-mono bg-yellow-500/10 px-3 py-1 rounded-lg">!join</span> في الدردشة للدخول
          </p>
        ...
        <div className="flex h-full w-full gap-6 relative font-arabic" dir="rtl">
          ...
          {showStreamerBox && (
            <motion.div
              drag
              dragMomentum={false}
              className="absolute z-50 top-4 right-4 bg-zinc-900/95 backdrop-blur-md border-2 border-purple-500/50 rounded-xl p-4 shadow-2xl w-80 cursor-move"
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-zinc-950 border border-purple-500/30 rounded-lg pr-10 pl-4 py-2 text-white text-sm focus:ring-2 focus:ring-purple-500 outline-none"
          ...
          {!showStreamerBox && (
            <button
              ...
              className="absolute top-4 right-4 bg-purple-600/20 hover:bg-purple-600/40 text-purple-400 border border-purple-500/30 px-4 py-2 rounded-lg flex items-center gap-2 text-sm transition-colors z-10"
            >
            ...
            <div className="flex-1 bg-zinc-800/30 border border-zinc-700/50 rounded-2xl p-8 flex flex-col items-center justify-center relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-3xl">
                {questionData?.options.map((opt, i) => (
                  <div key={i} className="bg-zinc-800/80 border border-zinc-700 p-6 rounded-xl text-center text-2xl font-bold text-white flex items-center justify-start gap-4 shadow-lg">
                    <span className="bg-yellow-500/20 text-yellow-500 w-10 h-10 rounded-lg flex items-center justify-center text-xl shrink-0">
                      {i + 1}
                    </span>
              ...
              <p className="mt-8 text-zinc-400 text-lg">
                اكتب <span className="text-yellow-500 font-bold">الرقم</span> أو <span className="text-yellow-500 font-bold">الإجابة</span> في الدردشة!
              </p>
            </div>
          </div>
          ...
          <div className="w-80 flex flex-col gap-4">
            <div className="flex-1 bg-zinc-900 border border-zinc-800 rounded-xl p-4 flex flex-col min-h-0">
              <h3 className="text-sm font-medium text-zinc-400 mb-3 flex items-center gap-2">
                <Trophy className="w-4 h-4 text-yellow-500" /> لوحة الصدارة المباشرة
              </h3>
                ...
                {sortedPlayers.map((p, i) => (
                  <div key={p.username} className="flex items-center justify-between bg-zinc-800/50 px-3 py-2 rounded-lg border border-zinc-700/50">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-yellow-500 font-mono text-sm">{p.score}</span>
                      {p.currentAnswer ? (
        ...
        <div className="flex flex-col items-center justify-center h-full w-full max-w-4xl mx-auto font-arabic" dir="rtl">
          ...
          <div className="bg-zinc-800/80 border border-zinc-700 rounded-2xl p-6 w-full mb-6 flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-400">{questionData?.a}</p>
            </div>
          ...
          <button 
            ...
            className="bg-yellow-600 hover:bg-yellow-500 text-black font-bold py-4 px-12 rounded-xl transition-colors flex items-center justify-center gap-2 text-lg w-full max-w-md"
          >
      ...
      return (
        <div className="flex flex-col items-center justify-center h-full w-full max-w-4xl mx-auto font-arabic" dir="rtl">
          ...
          <div className="flex gap-4">
            ...
            <button 
              onClick={onLeave}
              className="bg-yellow-600 hover:bg-yellow-500 text-black font-bold py-3 px-8 rounded-xl transition-colors"
            >
              العودة للألعاب
            </button>
          </div>
